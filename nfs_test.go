...
func TestNFSHandles(t *testing.T) {
	...
	paths := []string{
		...
		"go4.org@v0.0.0-20230225012048-214862532bf5/media",
		"go4.org@v0.0.0-20230225012048-214862532bf5/media/heif",
		"go4.org@v0.0.0-20230225012048-214862532bf5/media/heif/heif.go",
		"github.com/!azure/azure-sdk-for-go/sdk/azcore@v1.11.0/arm",
